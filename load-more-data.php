...
$text_message = "";
$result_msglist = mysql_query("SELECT * FROM `internal_conversation` WHERE send_by IN ('".$received_by."','".$send_by."') and received_by IN ('".$received_by."','".$send_by."') LIMIT ".$total_message.", ".$data_limit);			
