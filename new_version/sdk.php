...
<body>
    ...
    /** 
     * fetchLiveChat from vendor api
     * @param {callback}
     */
    async function fetchLiveChat(callback) {
    ...
    /** callback chat operations after api call */
    const chatProcess = function() {
         ...
         **/
        const iHelpChatLogo = document.querySelector('.logo');
        if (iHelpChatLogo != null) {
            iHelpChatLogo.addEventListener('click', function() {
